...
## Installation
To run this project, ensure you have Python and pip installed. Then follow these steps:

1. Clone this repository:
   ```bash
   git clone https://github.com/dindaapermatasari/sentiment-product-review.git
   ```

2. Navigate to the project directory:
   ```bash
   cd sentiment-product-review
   ```
